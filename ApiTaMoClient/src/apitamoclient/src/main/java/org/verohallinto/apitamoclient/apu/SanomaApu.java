...
/**
 * <p>SOAP-sanomien käsittelyssä käytettävät staattiset apumetodit.</p>
...
public class SanomaApu {
     ...
     * </p>
     *
     * @param koodi  {@code String} sanoman virhekoodi.
     * @param selite {@code String} sanoman virheselite.
     * @return Sanoma SOAPFault-elementillä varustettuna tai virhetilanteessa null.
     */
     ...
     * </p>
     *
     * @param sanoma {@code SOAPMessage} virhesanoma.
     ...
     * </p>
     *
     * @param sanoma {@code SOAPMessage} muunnettava SOAP-sanoma.
     ...
     * </p>
     *
     * @param sanoma {@code String} muunnettava merkkijono.
     * @return Annettu sanoma merkkijonona tai virhetilanteessa null.
     */
    public static SOAPMessage merkkijonoSanomaksi(final String sanoma) {
        ...
        if (sanoma != null && sanoma.trim().length() != 0) {
            try {
                ...
                // Muodostetaan viestin sisältö lataamalla muokattu sisältö SOAP-sanomaan
     ...
     * </p>
     *
     * @param elementti {@code SOAPElement} muunnettava SOAP-elementti.
     * @return Elementti dokumenttinä, tai virhetilanteessa null.
     */
     ...
     * </p>
     *
     * @param elementti {@code SOAPElement} muunnettava elementti.
     ...
     * </p>
     *
     * @param doc {@code SOAPElement} muunnettava XML-dokumentti.
     * @return Merkkijonoksi muunnettu XML-dokumentti tai null, jos muunnos epäonnistui.
     */
     ...
     * </p>
     *
     * @param s {@code String} muunnettava merkkijono.
