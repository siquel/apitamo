...
public class ApitamoOutDto {
    ...
    private boolean liitteitaVastaanotettu;     // Yksi tai useampi liitetiedosto otettu vastaan. Tarkempi erittely löytyy "liitteet" -listasta.
    ...
    private String vastausSanomanNimi;          // Sanoman nimi, joka sisältää varsinaisen Apitamon vastauksen
