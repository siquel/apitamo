...
/**
 * <p>Katso-sisäänkirjautumistiedot.</p>
...
public class KatsoInDto implements Serializable {
    ...
    private int tunnistustapa;          // Tunnistautumisessa käytettävä menetelmä esim. Katso PWD tai Katso-OTP
    ...
    private boolean logMessages;        // Lokitetaanko lähetettävät ja vastaanotettavat sanomat
    ...
    // sisäiseen käyttöön
    private SOAPElement saslAssertion;  // SASLRespond-sanoman 'saml:Assertion'-elementti
    ...
    public String toString() {
        ...
        return "KatsoInDto{" + Vakiot.SYS_LF +
               "kieli='" + kieli + '\'' + Vakiot.SYS_LF +
               "tunnistustapa=" + tunnistustapa + Vakiot.SYS_LF +
               "kayttajatunnus='" + kayttajatunnus + '\'' + Vakiot.SYS_LF +
               "salasana='" + salasana + '\'' + Vakiot.SYS_LF +
               "otpSalasana='" + otpSalasana + '\'' + Vakiot.SYS_LF +
               '}';
    }
}
