...
public class ApitamoClient {
     ...
     * </p>
     *
     * @param in {@code KatsoInDto} sis‰‰nkirjautumistiedot.
    ...
    public static KatsoOutDto katsoSisaan(final KatsoInDto in) {
        ...
        if (log.isLoggable(Level.INFO)) {
            log.info("katsoSisaan(): " +
                     "Tunnus='" + katso.getIn().getKayttajatunnus() +
                     "', tunnistus ok=" + katso.getOut().onTunnistusOk() +
                     ", vahva tunnistus=" + katso.getOut().onVahvaTunnistus() +
     ...
     * </p>
     *
     * @param in {@code ApitamoInDto} L‰hetett‰v‰t tiedot
     ...
     * </p>
     *
     * @param apitamo {@code ApitamoDto} L‰hetyksen tiedot.
     ...
     *
     * @param in {@code KatsoInDto} sis‰‰nkirjautumistiedot.
     * @throws RuntimeException Kirjautumistiedot virheelliset.
     */
    private static void tarkastaKatso(final KatsoInDto in) {
        ...
        if (in != null) {
            ...
            if (Apuri.onTyhja(in.getKayttajatunnus()) || Apuri.onTyhja(in.getSalasana()) ||
                !ttOk || (in.getTunnistustapa() == Vakiot.KATSO_OTP && Apuri.onTyhja(in.getOtpSalasana()))) {

                String ex = "Virheelliset tunnistautumistiedot:" +
                            ", tunnistustapa=" + annaTapa(in.getTunnistustapa(), ttOk) +
                            ", k‰ytt‰j‰tunnus=" + annaPakollinen(in.getKayttajatunnus()) +
                            ", salasana=" + annaSalasana(in.getSalasana());
     ...
     *
     * @param s {@code String} tarkastettava pakollinen tieto.
     ...
     *
     * @param s {@code String} tarkastettava pakollinen salasanatieto.
     * @return Tiedon status merkkijonona.
     */
     ...
     *
     * @param tapa {@code int} tarkastettava pakollinen tunnistustapa.
     * @param ttOk {@code boolean} tiedon tila.
     * @return Tiedon status merkkijonona.
     */
