...
public class Vakiot {
    ...
    //
    public static final String KATSO_AIKAVYOHYKE = "UTC"; // Katso-aikaleimoissa käytettävä aikavyöhyke
    public static final String KATSO_AIKALEIMA = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"; // Katso-sanomissa käytettävän aikaleiman muoto
    //
    public static final String SANOMAMERKISTO = "UTF-8"; // Sanomissa käytettävä merkistö
    public static final String SOAP_ENV_CLIENT = "SOAP-ENV:Client"; // Virhesanoman koodi
    public static final String SOAP_ENV_SERVER = "SOAP-ENV:Server"; // Virhesanoman koodi
    public static final Charset ISO88591_CHARSET = Charset.forName("ISO-8859-1");
    public static final Charset UTF8_CHARSET = Charset.forName("UTF-8");
    // Tunnistautumistavat
    public static final int KATSO_OTP = 1; // Katso-tunnistautumismenetelmä Katso OTP
    public static final int KATSO_PWD = 2; // Katso-tunnistautumismenetelmä Katso PWD
    ...
    public static final char KATSO_SASL_EROTIN = 0x00; // SaslRequest-sanoman tunnistautumismerkkijonon erotinmerkki
