...
/**
 * <p>Yksittäisen lomakkeen tarkastustulos</p>
 * (c) 2014 Tietokarhu Oy
 */
public class LomakeDto {

    private boolean lomakkeenTilaOk;    // Lomakekohtainen tarkistuksen tila
    private String lomakeVuosi;         // Lomakkeen vuosi(esim. tuloveroilmoituksilla ja vuosi-ilmoituksilla)
    ...
    public String toString() {
        return "LomakeDto{" + Vakiot.SYS_LF +
               "lomakkeenTilaOk='" + lomakkeenTilaOk + '\'' + Vakiot.SYS_LF +
               "lomakeVuosi=" + lomakeVuosi + Vakiot.SYS_LF +
               "selite=" + selite + Vakiot.SYS_LF +
               "tietueTunnus=" + tietueTunnus + Vakiot.SYS_LF +
               "yTunnus='" + yTunnus + '\'' + Vakiot.SYS_LF +
               "virheet='" + virheet + '\'' + Vakiot.SYS_LF +
               '}';
    }
}
