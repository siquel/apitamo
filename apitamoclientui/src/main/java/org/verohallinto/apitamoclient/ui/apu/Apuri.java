...
public class Apuri {
   ...
   *
   * @param c
   *          <code>char</code> tutkittava merkki.
   ...
   *
   * @param s
   *          <code>String</code> tutkittava merkkijono.
  ...
  /**
   * Tarkastaa onko annettu merkkijono hyv�ksytt�v� true-arvo.
   * </p>
   *
   * @param s
  ...
  public static String annaPoikkeus(final Exception e) {
    ...
    return Vakiot.class.getCanonicalName() + ".annaPoikkeus(): Poikkeus on tyhj�.";
  }
}
