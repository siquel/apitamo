...
/**
 * <p>Katso-sis‰‰n-/uloskirjautumisen paluutiedot.</p>
...
public class KatsoOutDto implements Serializable {
    ...
    private String tunnistusId;         // K‰ytett‰v‰n tunnistustavan id. Esim. 'jakelin-sftp'
    private int tunnistustapa;          // Tunnistautumisessa k‰ytett‰v‰ menetelm‰ esim. Katso PWD, Katso-OTP, KTYVI...
    private boolean vahvaTunnistus;     // true = tunnistauduttu vahvalla tunnistusmenetelm‰ll‰, false = heikompi tunnistautuminen
    ...
    private String info;                // Mahdollinen info-tieto esim. otp-vaihtuvien salasanojen loppumisesta
    private String virhe;               // Virheilmoitus tunnistautumisen ep‰onnistumisesta
    private SOAPElement assertion;      // AuthnRespond-sanoman 'saml:Assertion'-elementti. V‰litet‰‰n l‰hetyksen yhteydess‰ ApiTaMolle
    private Date assertionDeadline;     // kellonaina, jolloin assertio vanhenee
    private boolean tunnistusOk;        // true = k‰ytt‰j‰ on sis‰‰nkirjautunut, false = kirjautuminen ep‰onnistui
    ...
    public String toString() {
        ...
        return "KatsoOutDto{" + Vakiot.SYS_LF +
               "tunnistusId='" + tunnistusId + '\'' + Vakiot.SYS_LF +
               "tunnistustapa=" + tunnistustapa + Vakiot.SYS_LF +
               "tunnistusOk=" + tunnistusOk + Vakiot.SYS_LF +
               "vahvaTunnistus=" + vahvaTunnistus + Vakiot.SYS_LF +
               "tfiKid='" + tfiKid + '\'' + Vakiot.SYS_LF +
               "tfiPersonname='" + tfiPersonname + '\'' + Vakiot.SYS_LF +
               "tfiVersion='" + tfiVersion + '\'' + Vakiot.SYS_LF +
               "info='" + info + '\'' + Vakiot.SYS_LF +
               "virhe='" + virhe + '\'' + Vakiot.SYS_LF +
               '}';
    }
}
