...
public class ApitamoInDto {
    ...
    private int suunta;                     // lähetyksen tyyppi 1 = aineiston lähetys, 2 = palautettavan aineiston nouto
    ...
    public String toString() {
        ...
        return "ApitamoInDto{" + Vakiot.SYS_LF +
               "kieli='" + kieli + '\'' + Vakiot.SYS_LF +
               "data='" + data + '\'' + Vakiot.SYS_LF +
               "assertion=" + assertion + Vakiot.SYS_LF +
               "liiteTiedostot='" + liiteTiedostot.toString() + '\'' + Vakiot.SYS_LF +
               "suunta='" + suunta + '\'' + Vakiot.SYS_LF +
               "email='" + email + '\'' + Vakiot.SYS_LF +
               '}';
    }
}
