...
/**
 * <p>Lomakkeen yksittäinen virherivi</p>
...
public class VirheriviDto {
    ...
    public String toString() {
        return "VirheriviDto{" + Vakiot.SYS_LF +
               "tunnus='" + tunnus + '\'' + Vakiot.SYS_LF +
               "rivinro=" + rivinro + Vakiot.SYS_LF +
               "tieto=" + tieto + Vakiot.SYS_LF +
               "selitys=" + selitys + Vakiot.SYS_LF +
               '}';
    }
}
