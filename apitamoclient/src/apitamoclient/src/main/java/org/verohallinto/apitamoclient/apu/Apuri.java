...
public class Apuri {
     ...
     * </p>
     *
     * @param nro  {@code int} etunollitettava numero.
     * @param koko {@code int} haluttu tiedon pituus etunollineen.
     ...
     * </p>
     *
     * @param pituus {@code int} muodostettavan id:n pituus.
     ...
     * </p>
     *
     * @param ss   {@code String}[] tarkastettavat arvot.
     * @param koko {@code int} arvojen oletettu määrä.
     * @return true = taulukossa on oikea määrä arvoje, false = arvojen määrä on virheellinen.
     */
     ...
     * </p>
     *
     * @param aikaleima {@code String} muunnettava aikaleima.
     ...
     * </p>
     *
     * @param s {@code String} konvertoitava merkkijono.
