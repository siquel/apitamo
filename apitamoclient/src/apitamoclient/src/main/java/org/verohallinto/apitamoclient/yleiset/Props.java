...
public class Props {
     ...
     * </p>
     *
     * @param id {@code String} alustettavien tietojen id.
     */
     ...
     * </p>
     *
     * @param avain {@code String} tiedon avain.
     ...
     * </p>
     *
     * @param id    {@code String} tunnistus id.
     * @param avain {@code String} tiedon avain.
     * @return Annatun avaimen arvo tai null, jos tietoa ei löydy.
     */
    ...
    /**
     * Hakee annetun avaimen mukaisen properties int-arvon sovellus id:n perusteella.
     * </p>
     *
     * @param avain  {@code String} tiedon avain.
     * @param oletus {@code int} oletusarvo, joka palautetaan, jos tietoa ei löydy..
     ...
     * </p>
     *
     * @param kieli {@code String} kielikoodi, jolla teksti halutaan.
     * @param nro   {@code int} halutun tekstin numero.
     ...
     * @param kieli {@code String} kielikoodi, jolla teksti halutaan.
     * @param nro   {@code int} halutun tekstin numero.
     * @param param {@code String}[] mahdolliset korvausparametrit.
     * @return Haluttu teksti jos löytyy, muuten null.
     */
     ...
     * </p>
     *
     * @param id {@code String} luettavan properties-tiedoston sovellustunnus.
     */
