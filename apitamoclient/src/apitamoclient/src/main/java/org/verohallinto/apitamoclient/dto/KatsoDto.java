...
/**
 * <p>Katso-tunnistautumistiedot.</p>
...
public class KatsoDto implements Serializable {
    ...
    private Date voimassa;      // Tunnistautumisen viimeinen voimassaoloaika (nyt + 10 min.)
    ...
    public String toString() {
        ...
        return "KatsoDto{" + Vakiot.SYS_LF +
               "saslMsgID='" + saslMsgID + '\'' + Vakiot.SYS_LF +
               "authnMsgID='" + authnMsgID + '\'' + Vakiot.SYS_LF +
               "voimassa=" + voimassa + Vakiot.SYS_LF +
               "in=" + in + Vakiot.SYS_LF +
               "out=" + out + Vakiot.SYS_LF +
               '}';
    }
}
