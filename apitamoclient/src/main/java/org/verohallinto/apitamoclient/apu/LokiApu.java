...
/**
 * <p>
 * Staattisia apumetodeita sanomien lokitukseen.
 * </p>
...
public class LokiApu {
   ...
   *
   * @param tiedosto
   *          {@code String} kirjoitettava tiedosto.
   * @param sanoma
   *          {@code SOAPMessage} lokitettava sanoma.
   */
   ...
   *          {@code String} kirjoitettava tiedosto.
   * @param elementti
   *          {@code SOAPElement} lokitettava elementti.
   */
    ...
    if (elementti != null) {
      ...
      try {
        bw = new BufferedWriter(
            new OutputStreamWriter(new FileOutputStream(annaLokiJnro() + "-" + tiedosto), Vakiot.SANOMAMERKISTO));
   ...
   *          {@code String} kirjoitettava tiedosto.
   * @param doc
   *          {@code SOAPElement} lokitettava dokumentti.
   */
