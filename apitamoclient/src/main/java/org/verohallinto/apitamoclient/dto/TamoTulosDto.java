...
public class TamoTulosDto {
  ...
  private long tietueKpl; // Ilmoituksia yhteens�
  private long oikeellisia; // Oikeellisia ilmoituksia yhteens�
  private long virheellisia; // Virheellisia ilmoituksia yhteens�
  ...
  public String toString() {
    return "TamoTulosDto{" + Vakiot.SYS_LF + "tarkistuksenTulosOk='" + tarkistuksenTulosOk + '\'' + Vakiot.SYS_LF
        + "tietueKpl=" + tietueKpl + Vakiot.SYS_LF + "oikeellisia=" + oikeellisia + Vakiot.SYS_LF + "virheellisia="
        + virheellisia + Vakiot.SYS_LF + "lomakkeet='" + lomakkeet + '\'' + Vakiot.SYS_LF + '}';
  }
}
