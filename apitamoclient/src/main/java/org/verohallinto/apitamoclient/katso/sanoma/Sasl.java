...
/**
 * <p>
 * SASLRequest-sanoman l�hetys ja vastaussanoman k�sittely.
 * </p>
...
public class Sasl {
  ...
  /**
   * Sanoman XPath-k�sittelyss� k�ytett�v�t Namespace-m��ritykset
   */
  ...
  static {
    ...
    NAMESPACE_CONTEXT.setNamespace("wsse",
        "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd");
    NAMESPACE_CONTEXT.setNamespace("wsu",
  ...
  /**
   * SASLRequest-pyynt�sanoman l�hetys.
   * </p>
   *
   * @param katso
   *          {@code KatsoDto} k�ytt�j�n tiedot.
    ...
    try {
      ...
      if (Props.lokitaSanomat()) {
        LokiApu.lokitaSanoma(
            LokiApu.annaEtuliite(Vakiot.KATSO_PYYNTO_SASL) + "Pyynto_" + System.currentTimeMillis() + ".xml", pyynto);
      }
      ...
      if (Props.lokitaSanomat()) {
        LokiApu.lokitaSanoma(
            LokiApu.annaEtuliite(Vakiot.KATSO_PYYNTO_SASL) + "Vastaus_" + System.currentTimeMillis() + ".xml", vastaus);
      }
      ...
      if (!runko.hasFault()) {
        ...
        // K�sitell��n ja tarkastetaan vastaussanoma
   ...
   * @param katso
   *          {@code KatsoDto} k�ytt�j�n tiedot.
   * @return SASLRequest-sanoma k�ytt�j�n tiedoilla.
  ...
  private static SOAPMessage muodostaPyynto(final KatsoDto katso) throws IOException, SOAPException {
    ...
    if (pohja != null) {
      ...
      // txt.101=SASLRequest-sanomapohjaa ei l�ydy.
  ...
  /**
   * SASL-kirjautumisessa k�ytett�v�n tunnistusmerkkijonon muodostus.
   * </p>
   *
   * @param dto
   *          {@code TunnistusDto} Tunnistautumistiedot.
   * @return Tunnistautumismerkkijono tai virhetilanteessa null.
   * @throws java.io.IOException
   *           tunnistautumismerkkijonon koodaus ep�onnistui.
   * @throws RuntimeException
   *           Virheellinen tunnistatumistapa.
   */
  private static String annaTunnistautuminen(final KatsoInDto dto) throws IOException {
    ...
    case Vakiot.KATSO_PWD:
      saData = Vakiot.KATSO_SASL_EROTIN + "katsole:" + dto.getKayttajatunnus() + Vakiot.KATSO_SASL_EROTIN
          + dto.getSalasana();
      break;
    case Vakiot.KATSO_OTP:
      saData = dto.getKayttajatunnus() + Vakiot.KATSO_SASL_EROTIN + dto.getSalasana() + Vakiot.KATSO_SASL_EROTIN
          + dto.getOtpSalasana();
      break;
    default:
      saData = null;
    ...
    if (saData == null) {
      ...
      throw new RuntimeException(
          Props.teksti(dto.getKieli(), 102, new String[] { String.valueOf(dto.getTunnistustapa()) }));
    }
  ...
  /**
   * SASLRespond-sanoman sanoman k�sittely.
   * </p>
   *
   * @param katso
   *          {@code KatsoDto} k�ytt�j�n tiedot.
   * @param vastaus
   *          {@code SOAPMessage} SASLRespond-sanoma.
   * @param xp
   *          {@code XPath} XPath-instanssi.
   * @throws javax.xml.soap.SOAPException
   *           SOAP-sanoman k�sittelyvirhe.
   * @throws javax.xml.xpath.XPathExpressionException
   *           Sanoman XPath-k�sittelyss� tapahtui virhe.
   * @throws java.io.IOException
   *           base64-koodaus/dekoodaus ep�onnistui.
   */
  private static void kasitteleVastaus(final KatsoDto katso, final SOAPMessage vastaus, final XPath xp)
    ...
    // K�sitell��n sanoman otsikkotiedot ja runko
   ...
   *          {@code KatsoDto} k�ytt�j�n tiedot.
   * @param vastaus
   *          {@code SOAPMessage} SASLRequest-vastaus.
   * @param xp
   *          {@code XPath} XPath-instanssi.
   * @throws javax.xml.soap.SOAPException
   *           SOAPHeader-elementin haku ep�onnistui.
   * @throws javax.xml.xpath.XPathExpressionException
   *           Sanoman XPath-k�sittelyss� tapahtui virhe.
   * @throws RuntimeException
   *           Vastauksen sanoma-id ei t�sm�� l�hetetyn sanoman id:hen.
   * @throws java.io.IOException
   *           base64-dekoodaus ep�onnistui.
   */
  private static void tarkastaOtsikot(final KatsoDto katso, final SOAPMessage vastaus, final XPath xp)
    ...
    // Tarkastetaan, ett� l�hetetyn sanoman id vastaa saadun vastauksen id:t�
    ...
    if (relatesTo != null) {
      if (katso.getSaslMsgID() != null && katso.getSaslMsgID().equals(relatesTo)) {
        ...
        // txt.104=SASLRespond-sanoman '{0}'-elementin arvo ei vastaa odotettua
        // arvoa: Odotettu='{1}', palautettu='{2}'.
      ...
      // txt.103=SASLRespond-sanoman '{0}'-elementti� tai -attribuuttie ei l�ydy
      // tai se on tyhj�.
  ...
  /**
   * Sanoman 'lu:Status'-elementin tarkastus. Mahdollinen virhe palautetaan
   * SoapVastausDto-objektissa.
   * </p>
   *
   * @param katso
   *          {@code KatsoDto} k�ytt�j�n tiedot.
   ...
   *          {@code XPath} XPath-instanssi.
   * @throws javax.xml.soap.SOAPException
   *           SOAPBody-elementin haku ep�onnistui.
   * @throws javax.xml.xpath.XPathExpressionException
   *           Sanoman XPath-k�sittelyss� tapahtui virhe.
   * @throws RuntimeException
   *           Sanoman k�sittelyss� tapauhtui virhe tai sanoma on virheellinen.
   * @throws java.io.IOException
   *           base64-dekoodaus ep�onnistui.
   */
  private static void kasitteleStatus(final KatsoDto katso, final SOAPMessage vastaus, final XPath xp)
    ...
    final org.w3c.dom.Node n = (org.w3c.dom.Node) xp.evaluate(XPATH_LU_STATUS, vastaus.getSOAPBody(),
        XPathConstants.NODE);
    ...
    if (n != null) {
      ...
      if ("OK".equalsIgnoreCase(code)) {
        ...
        // K�ytt�j�tunnus ja salasana on ok, mutta vaihtuva salasana on v��rin
        // Parsitaan vastaussanomasta oikea salasanan j�rjestysnumero
        ...
        if (saData != null && saData.length() != 0) {
          ...
          // txt.113=Seuraavan vaihtuvan salasanan j�rjestysnumero on {0}.
          ...
          // txt.103=SASLRespond-sanoman '{0}'-elementti� tai -attribuuttie ei
          // l�ydy tai se on tyhj�.
   ...
   *
   * @param kieli
   *          {@code String} ilmoitusten kielikoodi.
   * @param runko
   *          {@code SOAPMessage} SASLRespond-sanoman runkoelementti.
   * @param xp
   *          {@code XPath} XPath-instanssi.
   * @return SASLRespond-sanoman 'saml:Assertion'-elementti annetusta sanomasta
   *         tai virhetilanteessa null.
   */
  private static SOAPElement annaAssertion(final String kieli, final SOAPBody runko, final XPath xp) {
    ...
    try {
      ...
      if (n != null) {
        ...
        throw new RuntimeException("SASLRespond-sanoman 'saml:Assertion'-elementti� ei l�ydy.");
      }
    } catch (Exception e) {
      log.severe("annaAssertion() - " + Apuri.annaPoikkeus(e));
      // txt.115=SASLRespond-sanoman '{0}'-elementin k�sittelyss� tapahtui
      // virhe: {1}.
